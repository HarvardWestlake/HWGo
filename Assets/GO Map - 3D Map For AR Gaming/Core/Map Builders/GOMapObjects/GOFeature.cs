...
namespace GoMap
{
    ...
    public class GOFeature
    {
        ...
        public virtual IEnumerator CreateLine(GOTile tile, bool delayedLoad)
        {
            ...
            //Mapzen Streetnames
            if ((goTile.mapType == GOMap.GOMapType.Nextzen || goTile.mapType == GOMap.GOMapType.Mapbox || goTile.mapType == GOMap.GOMapType.Protomaps || goTile.mapType == GOMap.GOMapType.CustomTile) && layer != null && layer.layerType == GOLayer.GOLayerType.Roads && name != null && name.Length > 0 && goTile.useStreetnames && !isLoop && !goTile.useElevation)
            {
